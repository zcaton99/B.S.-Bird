...
//  B.S. Bird
//
//  Created by Zach Caton on 5/2/18.
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        if gameOver == false {
            ...
            if contact.bodyA.categoryBitMask == ColliderType.Gap.rawValue || contact.bodyB.categoryBitMask == ColliderType.Gap.rawValue {
                ...
                scoreLabel.text = "B.S. stage: " + String(score)
                ...
                gameOverLabel.text = "You couldnt't take any more B.S. Tap to play again."
    ...
    func setupGame() {
        ...
        let bgTexture = SKTexture(imageNamed: "bg1.bmp")
